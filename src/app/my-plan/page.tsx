...
function MyPlanContent() {
  ...
  const totalMinutes = currentList.reduce((total, workout) => total + workout.duration, 0);
  const totalCalories = currentList.reduce((total, workout) => total + workout.caloriesBurned, 0);
